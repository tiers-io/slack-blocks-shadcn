...
// Vendored from the consumer's `apps/web/src/components/ui/button.tsx`.
// Kept semantically identical so a future bump of the shadcn button
// upstream can be copy-pasted without touching block-level code.
